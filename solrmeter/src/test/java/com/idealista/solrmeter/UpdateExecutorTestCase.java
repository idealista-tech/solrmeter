...
import com.idealista.solrmeter.mock.UpdateExecutorSpy;
...
//	}
	...
	public void testMaxDocsBeforeCommit() throws InterruptedException{
		...
		assertEquals(0, updateExecutor.getNotCommitedDocuments());
		assertEquals(1, ((SolrClientMock)updateExecutor.getSolrClient()).getNumberOfCommits());
		updateExecutor.stop();
	}
	...
	public void testAutocommit() {
		...
		assertEquals(0, updateExecutor.getNotCommitedDocuments());
		assertEquals(0, ((SolrClientMock)updateExecutor.getSolrClient()).getNumberOfCommits());
