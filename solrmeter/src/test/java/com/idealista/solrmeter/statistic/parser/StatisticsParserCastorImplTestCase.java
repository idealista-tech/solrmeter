 ...
 */
package com.idealista.solrmeter.statistic.parser;

import java.util.List;

import com.idealista.solrmeter.BaseTestCase;
import com.idealista.solrmeter.controller.StatisticDescriptor;
import com.idealista.solrmeter.controller.StatisticScope;
import com.idealista.solrmeter.controller.StatisticType;
import com.idealista.solrmeter.controller.statisticsParser.ParserException;
import com.idealista.solrmeter.controller.statisticsParser.StatisticsParser;
import com.idealista.solrmeter.controller.statisticsParser.castor.StatisticsParserCastorImpl;
/**
 * 
 * @author tflobbe
 *
...
public class StatisticsParserCastorImplTestCase extends BaseTestCase {
	...
	public void testSimple() {
		try {
			...
			assertEquals(com.idealista.solrmeter.view.statistic.HistogramChartPanel.class, descriptor1.getViewClass());
			assertEquals(com.idealista.solrmeter.mock.MockStatistic.class, descriptor1.getModelClass());
