package com.idealista.solrmeter.statistic;
...
import com.idealista.solrmeter.model.statistic.CacheData;
...
public class RequestHandlerConnectionTestCase extends BaseTestCase {
	...
	public void testConnectionData() throws MalformedURLException, StatisticConnectionException {
		SolrClient solrClient = this.createMockSolrClient();
		RequestHandlerConnection connection = new RequestHandlerConnection(solrClient);
	...
	private SolrClient createMockSolrClient() throws MalformedURLException {
		return this.createMockSolrClient("queryResultCache", "fieldCache", "documentCache", "fieldValueCache", "filterCache");
	}
	
	 private SolrClient createMockSolrClient(String... caches) throws MalformedURLException {
	    SolrClientMock mock = new SolrClientMock();
	...
	private NamedList<Object> createStatsNamedList() {
	 ...
	 public void testMissingCaches() throws MalformedURLException, StatisticConnectionException {
		SolrClient solrClient = this.createMockSolrClient("filterCache");
	    RequestHandlerConnection connection = new RequestHandlerConnection(solrClient);
	    Map<String, CacheData> data = connection.getData();
	    assertNotNull(connection.getFilterCacheData(data));
