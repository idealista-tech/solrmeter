...
import com.idealista.solrmeter.model.operation.PingOperation;
import com.idealista.solrmeter.model.statistic.OperationRateStatistic;
import com.idealista.solrmeter.model.statistic.SimpleQueryStatistic;
import com.idealista.solrmeter.view.component.InfoPanel;
import com.idealista.solrmeter.view.component.RoundedBorderJPanel;
import com.idealista.solrmeter.view.component.SolrConnectedButton;
import com.idealista.solrmeter.view.component.SpinnerPanel;
...
public class QueryConsolePanel extends RoundedBorderJPanel implements ConsolePanel {
	...
	private PingOperation createPingOperation() {
		return new PingOperation(SolrClientFactory.getSolrClientForQuery());
	}
