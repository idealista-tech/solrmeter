...
import com.idealista.solrmeter.controller.ErrorLogController;
...
public class ErrorLogPanel extends StatisticPanel implements ActionListener, MouseListener {
	...
	private static final Logger logger = Logger.getLogger(ErrorLogPanel.class);
	
	private static final SimpleDateFormat dateFormat = new SimpleDateFormat(SolrMeterConfiguration.getProperty("solr.view.logPanel.dateFormat", "MM/dd/yyyy HH:mm:ss:SS"));
