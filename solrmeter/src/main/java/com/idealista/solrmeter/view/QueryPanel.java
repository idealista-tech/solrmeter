...
import com.idealista.solrmeter.view.component.IntegerField;
...
public class QueryPanel extends StatisticPanel {
  ...
  private static final int INPUT_PANEL_WIDTH = 250;
  
  private static final int OUTPUT_SPLIT_LOCATION = 90;
