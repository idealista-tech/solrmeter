...
import com.idealista.solrmeter.controller.FullQueryStatisticController;
...
import com.idealista.solrmeter.model.statistic.QueryLogStatistic.QueryLogValue;
...
import com.idealista.solrmeter.view.component.TooltipJTable;
...
public class FullQueryStatisticPanel extends StatisticPanel {
	...
	private static final Logger logger = Logger.getLogger(FullQueryStatisticPanel.class);
